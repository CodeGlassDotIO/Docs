---
title: Legal - EULA - Subscription Agreement for open source projects
description: The legal mumbo jumbo for open source subscription.
---
...
# Subscription Agreement for open source projects
...
# 1. PARTIES
1.1. "Customer" or "you" means the open source development group specified in the Subscription Confirmation.
...
2.2. “Agreement” means this Subscription Agreement for open source projects.

2.3. "Authorized User" means a software developer or other open source development group member who is authorized by Customer to use Products for the purpose of developing an open source project.

2.4. Removed

2.5. "CodeGlass Account” or “CGA” means the account explained at [https://codeglassdotio.github.io/Docs/docs/Others/Account](../../Others/Account.md) created by Customer or User, having a unique name and password, and enabling Customer or User to manage Subscription administration and/or access Products.

2.6. “Machine” means a computing device used by Customer for running the Product.

2.7. “Product” means any generally available TySoft software intended for mass distribution which may be designated by TySoft as part of the CodeGlass Suite, on CodeGlass’ website at CodeGlass.io. CodeGlass does not develop Products according to Customer’s specifications, nor are Products customized through modification or personalization.
...
# 3. GRANT OF RIGHTS
3.1. The Product is provided to you on a ‘per user’ basis, where you must assign a Subscription to a specific Authorized User who may deploy the Product on multiple Machines in accordance with the Product documentation.

3.2. Unless the Subscription has expired or this Agreement is terminated in accordance with Section 10, and subject to the terms and conditions specified in this Agreement, TySoft grants you the non-exclusive and non-transferable right to use each Product covered by the Subscription for a period of one (1) year as stipulated below:

(A) You may:

(i) install and use any version of the Product covered by the Subscription on any number of Machines and on any operating system supported by the Product, and allow Authorized Users to use the Product, solely for the purpose of the development of non-commercial open source projects that meet the Open Source Definition at [http://www.opensource.org/docs/osd](http://www.opensource.org/docs/osd); the right to use the Product for any other purposes is expressly prohibited; and
...
4.1. All deliveries under this Agreement will be electronic. Customer and its Authorized Users must have an Internet connection in order to access their CodeGlass Account and receive any deliveries. The Customer is responsible for downloading and installing the Products, which are made available for download on the CodeGlass website at [codeglass.io](https://codeglass.io).

4.2 Customer and their Authorized Users may use the CGA in accordance with the CodeGlass Account Agreement available at [https://codeglassdotio.github.io/Docs/docs/Legal/Account](../AccountAgreement.md). Customer and their Authorized Users are solely responsible for the accuracy of any information provided via, and any action taken through, the CGA.

4.3. Customer may enable Authorized Users to activate and access Products in one of the following ways:

(A) CodeGlass Account – by sending an invitation from Customer’s CGA to an Authorized User’s CGA. Customer acknowledges and agrees that the Product will periodically connect from an Authorized User’s Machine to LicenseSpring’ servers via the internet to confirm the Authorized User’s right to use the Product;
...
TySoft reserves the right to suspend Customer’s access to TySoft Products if Customer or User’s use of Product is in violation of this Agreement or disrupts or imminently threatens the security, integrity, or availability of a Product.
...
12.2. Customer must immediately report any concerns of non-compliance regarding Sanctions to support@codeglass.io, and cooperate with TySoft in its efforts to verify and ensure compliance with Sanctions.
...
The previous version of this agreement is available in git at [{{ site.repo }}/commits/master/_docs/Legal/EULA/OpenSourceSubscriptionAgreement.md]({{ site.repo }}/commits/master/_docs/Legal/EULA/OpenSourceSubscriptionAgreement.md).
