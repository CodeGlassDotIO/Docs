...
5.3 You may activate and access Products in the following ways

CodeGlass Account – You acknowledge and agree that the Product will periodically connect from a Machine to LicenseSpring servers via the Internet to confirm your right to use the Product;
