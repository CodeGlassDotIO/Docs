...
2.7. “Product Version” means a release, update, or upgrade of a particular Product that is not identified by CodeGlass BV as being made for the purpose of fixing software bugs.
...
2.12. "Stripe" means our payment provider at [https://stripe.com/](https://stripe.com/)
...
3.2. Unless the Subscription has expired or this Agreement is terminated in accordance with Section 10, and subject to the terms and conditions specified in this Agreement, CodeGlass BV grants Customer the non-exclusive and non-transferable right to use each Product covered by the Subscription for a period of 1 (one) year as stipulated below:
